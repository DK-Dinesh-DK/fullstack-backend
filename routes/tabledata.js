...
tableRouter.post("/data-upload", verifytoken, CheckAdmin, (req, res) => {
...
tableRouter.put("/update-details", verifytoken, CheckAdmin, (req, res) => {
...
tableRouter.delete("/delete-details", verifytoken, CheckAdmin, (req, res) => {
...
tableRouter.get("/get-tabledata", verifytoken, (req, res) => {
...
tableRouter.post("/user-list",verifytoken, CheckAdmin, (req, res) => {
